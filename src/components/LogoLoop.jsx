...
const ANIMATION_CONFIG = {
  SMOOTH_TAU: 0.25,
  MIN_COPIES: 4, // زيادة الحد الأدنى للتكرارات
  COPY_HEADROOM: 2,
};
...
const useAnimationLoop = (
  ...
  useEffect(() => {
    ...
    if (seqWidth > 0) {
      ...
      const translateX =
        direction === "right" ? offsetRef.current : -offsetRef.current;
    ...
    const animate = (timestamp) => {
      ...
      if (seqWidth > 0) {
        ...
        const translateX = direction === "right" ? nextOffset : -nextOffset;
        track.style.transform = `translate3d(${translateX}px, 0, 0)`;
      }
...
export const LogoLoop = memo(
  ({
    ...
    useAnimationLoop(
      ...
      isHovered,
      pauseOnHover,
      direction, // تمرير direction إلى useAnimationLoop
    );
    ...
    const rootClasses = useMemo(
      ...
      [scaleOnHover, className, direction],
    );
